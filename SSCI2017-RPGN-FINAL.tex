...
The below is from the paper Neuroevolution by Risto Miikulainen
...
Evolutionary computation is used to search for network parameters that meximize a fitness function that measures performance in the task [define: fitness function].
...
(the biological daptation is referring to the process of evolution through natural selection over hundreds of generations.)
...
This is going to be the section where you give some more information of how RL relates to NE, give some examples. draw a line to natural processes 


\subsection{HyperNEAT}

\subsection{Fitness Funcitons}

=======================================================================================================
THe outtake belowis also from the Riisto Miikulainen paper 2010

Compared to other neural network learning methods, neuroevolution is highly general, allowing learning without explicit targets, with nondifferentiable activation functions and with recurrent networks.
...
There we different evaluations for the different experiments:
...
This will also help us determine whether or not an evolved ANN controller is transferrable between robot bodies. In other words, once a controller has been trained to accomplish a certain task, will this controller be able to still complete its task after being transferred into another "body"
